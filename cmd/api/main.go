...
func main() {
	...
	onboardingService := onboarding.NewService(onboarding.NewRepository(pool), brandMemoryService, contentService, experimentService, performanceService, publishingService, communityService, publishing.ParseWindows(cfg.PublishWindows()), xClient, xAccountService, linkedinClient, linkedinAccountService, openAIClient)
